...
class PriceDescAdapter(var context: Context, var descList:ArrayList<VariantsItem>): RecyclerView.Adapter<PriceDescAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.descTxt.text=context.resources.getString(R.string.rupee)+descList[position]?.price?.toString()
    }
